---
title: "Metaxy + ClickHouse"
description: "Learn how to use ClickHouse as a Metaxy metadata store."
---

# Metaxy + ClickHouse

[ClickHouse](https://clickhouse.com/) is a (1) column-oriented OLAP database designed for real-time analytics. To use Metaxy with ClickHouse, configure [`ClickHouseMetadataStore`][metaxy.ext.clickhouse.ClickHouseMetadataStore]. Versioning computations run natively in ClickHouse, making it well-suited for high-throughput production workloads.
{ .annotate }
...
::: metaxy.ext.clickhouse.ClickHouseMetadataStore
    options:
      members: false
      heading_level: 3
<!-- dprint-ignore-end -->
...
<!-- dprint-ignore-start -->
::: metaxy-config
    class: metaxy.ext.clickhouse.ClickHouseMetadataStoreConfig
