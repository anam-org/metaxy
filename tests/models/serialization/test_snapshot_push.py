...
def test_record_snapshot_first_time(tmp_path: Path):
    ...
    with graph.use():
        ...
        with DeltaMetadataStore(root_path=tmp_path / "delta_store").open("w") as store:
            ...
            versions_lazy = store._read_feature(store._to_table_id(FEATURE_VERSIONS_KEY))
    ...
    with graph_v1.use():
        ...
        with DeltaMetadataStore(root_path=tmp_path / "delta_store").open("w") as store:
            ...
            with graph_v2.use():
                ...
                versions_lazy_after = store._read_feature(store._to_table_id(FEATURE_VERSIONS_KEY))
...
def test_record_snapshot_append_only_behavior(tmp_path: Path):
    ...
    with graph_v1.use():
        ...
        with DeltaMetadataStore(root_path=tmp_path / "delta_store").open("w") as store:
            ...
            versions_lazy_v1 = store._read_feature(store._to_table_id(FEATURE_VERSIONS_KEY))
            ...
            with graph_v2.use():
                ...
                versions_lazy_v2 = store._read_feature(store._to_table_id(FEATURE_VERSIONS_KEY))
    ...
    with graph_v1.use():
        ...
        with DeltaMetadataStore(root_path=tmp_path / "delta_store").open("w") as store:
            ...
            with graph_v2.use():
                ...
                versions_lazy2 = store._read_feature(store._to_table_id(FEATURE_VERSIONS_KEY))
