import{p as U}from"./chunk-WASTHULE-C-DZqFY-.js";import{p as H}from"./treemap-GDKQZRPO-K4MNJ6LD-CrJrXHfY.js";import{g as V,s as Z,a as j,b as q,v as J,t as K,c as s,l as w,d as Q,G as X,a7 as Y,a9 as ee,aa as G,ab as te,f as ae,A as re,ac as ie,H as se}from"./Mermaid.vue_vue_type_script_setup_true_lang-B3Ftbgu8.js";import"./chunk-MFRUYFWM-Be8IyHKL.js";import"./index-BMlti1zG.js";import"./modules/vue-aalH_SXY.js";import"./modules/shiki-D_M5EFjr.js";import"./lz-string-BCxBxReP.js";import"./modules/file-saver-B7oFTzqn.js";var le=se.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,oe=structuredClone(le),ne=s(()=>structuredClone(oe),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,re()},"clear"),pe=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),de=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),W={getConfig:ne,clear:ce,setDiagramTitle:K,getDiagramTitle:J,setAccTitle:q,getAccTitle:j,setAccDescription:Z,getAccDescription:V,addSection:pe,getSections:de,setShowData:ge,getShowData:ue},fe=s((e,a)=>{U(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),he={parse:s(async e=>{const a=await H("pie",e);w.debug(a),fe(a,W)},"parse")},me=s(e=>`
  .pieCircle{
