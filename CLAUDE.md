...
2. Implement abstract methods: `_get_default_hash_algorithm()`, `_create_provenance_tracker()`, `open()`, `close()`, `write_metadata_to_store()`, `read_metadata_in_store()`, `_drop_feature_metadata_impl()`, `_list_features_local()`
