...
2. Implement abstract methods: `_get_default_hash_algorithm()`, `_supports_native_components()`, `_create_native_components()`, `open()`, `close()`, `_write_metadata_impl()`, `read_metadata_in_store()`, `_drop_feature_metadata_impl()`
