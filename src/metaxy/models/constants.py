...
# metaxy_provenance_by_field is always required for versioning
ESSENTIAL_SYSTEM_COLUMNS = frozenset(
    {
        "metaxy_provenance_by_field",  # Always required for versioning
    }
)
...
DROPPABLE_SYSTEM_COLUMNS = frozenset(
    {
        ...
        "metaxy_metaxy_provenance_by_field",
    }
)
