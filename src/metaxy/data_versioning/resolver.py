...
#     new = incoming.join(
#         current.select(feature_spec.id_columns),
...
#         how="inner",
#         suffix="_current",
#     ).filter(nw.col(PROVENANCE_COL) != nw.col(PROVENANCE_COL + "_current"))
...
#     assert len(upstream_metadata) > 0, (
#         "upstream_metadata must be provided for non-root features"
#     )
