...
class MetaxyStoreFromConfigResource(dg.ConfigurableResource[mx.MetadataStore]):
    """This resource creates a [`metaxy.MetadataStore`](https://docs.metaxy.io/stable/guide/concepts/metadata-stores/) based on the current Metaxy configuration (`metaxy.toml`).
