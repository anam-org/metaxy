"""ClickHouse compute engine using Ibis."""
...
class ClickHouseVersioningEngine(IbisVersioningEngine):
    ...
    def concat_strings_over_groups(
        ...
        def arrayStringConcat(arr: list[str], sep: str) -> str:  # ty: ignore[empty-body]
...
class ClickHouseEngine(IbisComputeEngine):
    ...
    def config_model(cls) -> type[IbisMetadataStoreConfig]:
        from metaxy.ext.clickhouse.metadata_store import ClickHouseMetadataStoreConfig
