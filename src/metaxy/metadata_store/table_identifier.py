...
class SQLTableIdentifier(TableIdentifier):
...
@dataclass(frozen=True, slots=True)
class DeltaTableIdentifier(TableIdentifier):
...
@dataclass(frozen=True, slots=True)
class LanceTableIdentifier(TableIdentifier):
    """Identifies a LanceDB table by name."""
