...
class MetadataStore(ABC):
    ...
    @abstractmethod
    def _create_provenance_tracker(self) -> ProvenanceTracker:
        """Create provenance tracker for this store.
    ...
    def validate_hash_algorithm(
        ...
        try:
            ...
            raise HashAlgorithmNotSupportedError(
                f"Hash algorithm {self.hash_algorithm} not supported by {self.__class__.__name__}: {e}"
            )
    ...
    def _resolve_update_native(
        ...
        *,
        ...
        # Get the provenance tracker for this store
    ...
    def _resolve_update_polars(
        ...
        *,
        ...
        tracker = PolarsProvenanceTracker(graph=feature.graph)
        logger.debug(
