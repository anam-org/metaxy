...
def launcher(
    *tokens: Annotated[str, cyclopts.Parameter(show=False, allow_leading_hyphen=True)],
    ...
    Feature definitions are collected via [feature discovery](https://docs.metaxy.io/stable/learn/feature-discovery/).
...
app.command("metaxy.cli.history:app", name="history")
