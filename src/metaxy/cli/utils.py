...
FilterArgs = Annotated[
    ...
    cyclopts.Parameter(
        name=["--filter"],
        help="SQL WHERE clause [filter](https://docs.metaxy.io/latest/guide/concepts/filters/) applied to the result of the status increment. Can be repeated.",
...
GlobalFilterArgs = Annotated[
    ...
    cyclopts.Parameter(
        name=["--global-filter"],
        help="SQL WHERE clause [filter](https://docs.metaxy.io/latest/guide/concepts/filters/) applied to all features being selected (including upstream). Can be repeated.",
        converter=_convert_filters,
        accepts_keys=False,
    ),
]
